...
const AdminCont = () => {
  ...
  const fetchCont = async () => {
    try {
      const response = await fetch("https://mern-stack-4ckn.onrender.com/admin/getcontacts", {
        method: "GET",
        headers: {
  ...
  const deleteMsg = async(id) =>{
    try {
      const response = await fetch(`https://mern-stack-4ckn.onrender.com/admin/getcontacts/delete/${id}`,{
        method:"DELETE",
        headers:{
          "Authorization":`Bearer ${token}`
        }
